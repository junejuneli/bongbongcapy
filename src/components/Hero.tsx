      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-700 font-cute">
                  {t('hero.subtitle')}
                </span>
              </motion.h1>
            </div>
            ...
            {/* 描述 */}
            <motion.div
              className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-body"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {[
                ...
                <motion.div
                  key={item.text}
                  className={`flex items-center gap-2 px-4 py-2 rounded-full glass-morphism font-cute font-medium`}
            ...
            >
              <motion.a
                href="#download"
                className="btn-primary font-cute inline-flex items-center gap-3"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.div
              ...
              <motion.a
                href="#gameplay"
                className="btn-secondary font-cute inline-flex items-center gap-3"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.div
          ...
          >
            ...
            {/* 浮动装饰元素 */}
            <motion.div
              className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-lotus-400 to-lotus-600 rounded-full flex items-center justify-center shadow-lg"
            ...
            <motion.div
              className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-r from-pond-400 to-pond-600 rounded-full flex items-center justify-center shadow-lg"
